...
<template>
    <div>
                ...
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-5">
                        <div class="max-w-xl text-sm text-gray-500">
                            Once this user is deleted, all of its resources and data will be permanently deleted. Before deleting your user, please download any data or information that you wish to retain.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <ConfirmationDialog @confirmed="submit" :show="confirm" @canceled="confirm = false" title="Delete user" confirm-text="Delete">
            This action is permanent action. Once this user is deleted, all of its resources and data will be permanently deleted.
        </ConfirmationDialog>
    </div>
</template>
